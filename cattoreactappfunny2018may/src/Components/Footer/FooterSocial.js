    ...
    return (
      <ul className="flexRowNoWrap justifyContentFlexEnd" >
        ...
        <li className="width30px">
          <a href="https://www.youtube.com/newellbrands" target="_blank" rel="noopener noreferrer">
        ...
        <li className="width10px"></li>
        <li className="width30px ">
          <a href="https://www.instagram.com/newellbrands/" target="_blank" rel="noopener noreferrer">
            <img className="square25" src="https://readypublication.com/wp-content/uploads/instagram.png" alt={"Insta"} />
          </a>
        </li>
        <li className="width10px"></li>
        <li className="width30px">
          <a href="https://www.facebook.com/newellbrands/" target="_blank" rel="noopener noreferrer">
        ...
        <li className="width10px"></li>
        <li className="width30px">
          <a href="https://twitter.com/newell_brands?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" rel="noopener noreferrer">
